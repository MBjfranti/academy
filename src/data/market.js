...
export const AISLES = [
  ...
  { key: 'dairy', label: 'Dairy', blurb: 'Sheep and goat first, cow a distant second, and sour is the point and not the problem.' },
  {
    key: 'fats',
    label: 'Oil, fat & sweet',
...
export const items = [
  // ─────────────────────────── PRODUCE ───────────────────────────
  { name: 'Onions', aisle: 'produce', verdict: 'yes', note: 'Brown, white or red, whichever is cheapest. The Babylonians put onions in nearly everything, and the pots here are built the same way: onions down first, cooked slowly until they go soft and sweet.', alias: 'onion' },
  ...
  { name: 'Leeks', aisle: 'produce', verdict: 'yes', note: 'More important than onions in Mesopotamian cooking, which is saying something. Use the green tops as well as the white. This food wastes almost nothing.', alias: 'leek' },
  ...
  { name: 'Spring onions', aisle: 'produce', verdict: 'yes', note: 'Your stand-in for kurrat: a thin Egyptian and Levantine leek grown for its leaves and not its stem. Use the green as well as the white.', alias: 'scallion green onion' },
  ...
  { name: 'Turnips', aisle: 'produce', verdict: 'yes', note: 'Old, plain and entirely legitimate. It wants long slow cooking in a pot, not a quick boil. Rushed, it stays woody and sullen.', alias: 'turnip' },
  ...
  { name: 'Celery', aisle: 'produce', verdict: 'yes', note: 'Named on the Mycenaean palace lists, which are inventories and not menus. It was there, but nobody wrote down what they did with it. Keep the leaves; they carry more flavour than the stalks.', cultures: ['aegean'] },
  ...
  { name: 'Grapes', aisle: 'produce', verdict: 'yes', note: 'Grapes and raisins both. Raisins are the more useful form once you start cooking, and hard unripe grapes are one of the few properly sour things in this pantry.', alias: 'raisins sultanas' },
  ...
  { name: 'Apples', aisle: 'produce', verdict: 'yes', note: 'Buy small and sharp, not big and sweet. Modern dessert apples have been bred a long way towards sugar.', alias: 'apple' },
  ...
  { name: 'Melon', aisle: 'produce', verdict: 'yes', note: 'Egyptian. Watermelon counts too. It is native to Africa and properly ancient, whatever it looks like sitting next to the rest of your basket.', alias: 'watermelon cantaloupe', cultures: ['egyptian'] },
  ...
  { name: 'Walnuts', aisle: 'produce', verdict: 'yes', note: 'Anatolian and Levantine. Crush them coarsely under the flat of a pan instead of chopping them. The ragged edges hold on to sauce.', alias: 'walnut' },
  ...
  { name: 'Carrots', aisle: 'produce', verdict: 'careful', note: 'Wild carrot existed, thin and pale and nowhere near sweet. The fat orange root in the shop is a much later breeding project. Use it sparingly, or not at all.', alias: 'carrot' },
  ...
  // ────────────────────────── DRY GOODS ──────────────────────────
   { name: 'Flatbread', aisle: 'drygoods', verdict: 'yes', note: 'Five recipes here assume a flatbread and none of them make you buy one. You can, though, and a plain shop-bought flatbread or pita is an honest stand-in. The hot-pan flatbread on the Recipes page takes twenty minutes and is better, and that is the only argument for making it.', alias: 'flatbread pita bread' },
 { name: 'Pearl barley', aisle: 'drygoods', verdict: 'yes', note: 'Barley has spent three thousand years being treated as wheat’s unfortunate cousin. This is slander. It is the staple grain of this entire world, it is cheap, every shop has it, and it is the single most important thing in your basket.', alias: 'barley pot barley' },
  { name: 'Wholemeal wheat flour', aisle: 'drygoods', verdict: 'yes', note: 'Your stand-in for emmer, which is a hulled wheat: the grain clings to its husk and has to be pounded free, and it is the wheat these kitchens milled. Modern wholemeal is lighter than the real thing, and a completely legitimate swap.', alias: 'whole wheat flour wholewheat atta' },
  ...
  { name: 'Millet', aisle: 'drygoods', verdict: 'careful', note: 'It crosses Asia and reaches Europe around 1500 BC, so it exists. But it is a northern grain and not one of these five kitchens, and you should use it knowing that.', cultures: [] },
  ...
  { name: 'Beef', aisle: 'meat', verdict: 'yes', note: 'Real, and expensive enough that a single ox turns up in palace records by name. Feast food and not weeknight food, and worth cooking as though it were.', tier: 'elite' },
  ...
  { name: 'Grey mullet', aisle: 'meat', verdict: 'yes', note: 'The Nile fish, and a coastal one too. Salting and drying it is the form that travelled, if you want to go that far.', alias: 'mullet', cultures: ['egyptian', 'canaanite'] },
  ...
  { name: 'Plain full-fat yoghurt', aisle: 'dairy', verdict: 'yes', note: 'Cow yoghurt works. Buy the highest fat you can find, because it splits far less when it meets a hot pot. Stir it in off the heat anyway.', alias: 'yoghurt yogurt natural plain' },
  ...
  { name: 'Pecorino & hard sheep cheese', aisle: 'dairy', verdict: 'yes', note: 'Hard sheep cheese was counted as palace treasure in the Aegean. Grate it over grain and pulses at the table instead of cooking it in.', alias: 'pecorino hard cheese sheep', cultures: ['aegean', 'hittite'] },
  ...
  { name: 'Eggs', aisle: 'dairy', verdict: 'careful', note: 'Duck and goose eggs, yes. Hen eggs run straight into the chicken problem, so treat eggs here as an absence and not a staple.', alias: 'egg eggs yolk yolks white whites' },
  { name: 'Cheddar, gouda & aged cow cheese', aisle: 'dairy', verdict: 'no', note: 'Later European techniques applied to a later European animal. The sheep cheeses a shelf over are what you want.', alias: 'cheddar gouda parmesan brie camembert', instead: 'Feta, halloumi or hard sheep cheese.' },
  ...
  { name: 'Linseed oil', aisle: 'fats', verdict: 'careful', note: 'Egyptian, and no qualification needed. Buy food-grade cold-pressed and read the bottle twice. The linseed oil in a hardware shop is for wood and is not food.', alias: 'flaxseed oil linseed', cultures: ['egyptian'] },
  ...
  { name: 'Cumin seed', aisle: 'seasoning', verdict: 'yes', note: 'Named on tablets from Babylon to Pylos. Buy it whole, not ground, and toast it in the hot fat before anything else goes in, until the smell comes up at you.', alias: 'cumin' },
  { name: 'Coriander seed', aisle: 'seasoning', verdict: 'yes', note: 'The workhorse spice of the era, and easy to overdo. One test pot here called for considerably more coriander than good judgment did, and good judgment won. Crack the seeds in a mortar instead of grinding them to dust, so you still meet them in the dish.', alias: 'coriander seed' },
  { name: 'Fresh coriander', aisle: 'seasoning', verdict: 'yes', note: 'The leaf, and it does a different job from the seed. Scatter it on raw at the end.', alias: 'cilantro coriander leaf' },
  ...
  { name: 'Mint', aisle: 'seasoning', verdict: 'yes', note: 'Named on the Mycenaean tablets. It belongs at the table and not in the pot, where long heat flattens it to nothing.', cultures: ['aegean', 'babylonian'] },
  ...
  { name: 'Mustard seed', aisle: 'seasoning', verdict: 'yes', note: 'The seed is old across the region. The yellow paste in a jar is a great deal later.', alias: 'mustard' },
  ...
  { name: 'Cinnamon', aisle: 'seasoning', verdict: 'careful', note: 'Possibly detected in a Canaanite wine jar. If that holds, it means trade across an astonishing distance. It is also unresolved, and argued over ever since. Use it knowing that, or not at all.', alias: 'cinnamon cassia', cultures: ['canaanite'], tier: 'elite' },
  ...
  { name: 'Stock cubes', aisle: 'seasoning', verdict: 'no', note: 'Simmer bones instead. It costs next to nothing, and the broth is doing real work in these dishes instead of sitting in the background.', alias: 'stock cube bouillon', instead: 'Lamb or beef bones, simmered an hour.' },
  ...
  { name: 'Retsina', aisle: 'drinks', verdict: 'yes', note: 'Wine flavoured with pine resin, and the closest thing on a shop shelf to what was drunk. An acquired taste, acquired quickly.', cultures: ['aegean', 'canaanite'] },
  { name: 'Cloudy wheat beer', aisle: 'drinks', verdict: 'careful', note: 'Beer is a staple food here and not a treat, and the Egyptians made much better beer than the Hittites did. Every modern beer is hopped and hops are medieval, so pick the cloudiest, least bitter thing on the shelf.', alias: 'beer wheat beer witbier', cultures: ['babylonian', 'egyptian', 'hittite'] },
  ...
  { name: 'Tahini', aisle: 'fats', verdict: 'yes', note: 'Ground sesame seed. Sesame was a Mesopotamian oil crop, so the paste is a fair extension and not an attested food: a modern convenience standing on old ground.', alias: 'tahini sesame paste', cultures: ['babylonian', 'canaanite'] },
  ...
  { name: 'Barley flour', aisle: 'drygoods', verdict: 'yes', note: 'The commoner’s loaf. Denser and sweeter than wheat, and it will not rise like wheat because it has almost no gluten. Closer to what most people ate.', alias: 'barley flour', tier: 'commoner' },
  ...
  // Each of these is called for by a shipped recipe and returned nothing when searched.
  {
    ...
    aisle: 'produce',
    verdict: 'careful',
    note: 'The Egyptian leek, grown for its leaf and not its stem, and named in the Babylonian recipes. A Middle Eastern grocer may have it. Otherwise the green tops of ordinary leeks do the same job and nobody will know.',
  ...
  },
  {
    ...
    aisle: 'produce',
    verdict: 'careful',
    note: 'Kamʾatu: gathered off the Syrian steppe after the spring rains and sent up to the palace at Mari. Sold fresh in the region in spring, occasionally frozen elsewhere. Nothing like a European truffle. Mild, meaty, and closer to a firm mushroom.',
  ...
  },
  {
    ...
    aisle: 'seasoning',
    verdict: 'careful',
    note: 'A sedge root, named in the Kabri wine residues and in Mycenaean perfume records. Hard to buy. Galangal is sold as a substitute and is a different plant from a different continent: a stand-in, not an equivalent.',
