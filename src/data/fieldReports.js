...
export const fieldReports = [
  {
    ...
    body: [
      ...
      'I wanted it to be ignorance. It is not. He knows what a man needs to know in order to do the thing he has to do, and nineteen years have shown him precisely where that line falls. The why is somebody else’s, in a room, on a tablet. And suppose they sent it down the column in the morning, with the rations. What then? He could not check a word of it. It would not shorten the eleven days by an hour and it would not change one minute of the standing.',
  ...
  },
  {
    ...
    body: [
      ...
      '“It is not simple.” She had the paddle in both hands and did not stop moving it. “It is cheap. You keep saying simple.” Iltani laughed at that without looking up. I have used the word about a dozen dishes on this journey. I have stopped using it.',
      ...
      'There is a rumour running along this stretch of river that farms are being burned somewhere south. I asked about it twice and got a different answer each time, neither of them from anybody who had seen anything. Bēltum has heard it. She said the sesame still has to come in.',
      'After dark she went out and drove a pair of geese off the bank with her arms out and a good deal of noise. I told her I had met a woman on Alašiya who spent an entire evening throwing stones at geese and never once hit one, on purpose, because hitting one would have meant plucking it and she was working. Bēltum thought about this for a moment. Then she said that she had hit one in the spring, and that it had cost her the better part of an afternoon, and that it had been worth every minute of it. She went back up to the table.',
      'Iltani was already laughing.',
  ...
  },
  {
    ...
    related: [
      ...
      { to: '/reports/four-days-of-eating-a-hillside', label: 'Why I was walking alone' },
    ...
    figures: [
      ...
      {
        name: 'terqa-market', at: 7, size: 'col',
      ...
      {
        name: 'terqa-talk', at: 6, size: 'inset',
      ...
      {
        name: 'terqa-evening', at: 12, size: 'col',
    ...
    body: [
      ...
      'The salt is harder to see than the silt and works the same way: water spread on a field and left to stand leaves behind whatever it was carrying, and the field takes it, and the next flood brings more, and the field takes that too. Do it for eight hundred years and the wheat goes out of the south and the barley comes in and the bread goes dark. Whether that is the salt or the politics, people argue.',
      'The ground grows saltier either way.',
  ...
  {
    slug: 'four-days-of-eating-a-hillside',
    kind: 'report',
    card: 'robbed-teaching',
    title: 'Four days of eating a hillside',
    region: 'levant',
    ...
    standfirst:
      'I came off that road with a cloak, a knife and an empty skin, and no very clear idea which side of the ridge I was on. This is what I found to eat.',
    hero: {
      name: 'robbed-raiders',
      ...
      caption: 'Look at the shields. Nobody carries a shield up a hill on the chance of meeting somebody worth robbing.',
    },
    figures: [
      {
    ...
    body: [
      'The twelfth morning went the way the eleven before it had gone. Šimatum had the third frame off the near animal before there was light enough to see it by and ran her thumb down the inside of the arm; the boy had the pot cold and scoured and lashed; we were up out of the camp and into the narrow part of the valley before the heat came into the day. I was thinking about breakfast. They came off the slope on both sides at once and it was finished before I understood that it had begun, eight or nine men with long spears, no charge, not one raised voice. Šimatum said a single sentence I did not catch and put both hands out flat with the palms towards the ground, and the two hired men did the same.',
      'Then their leader asked me whose man I was, in better Akkadian than I have. Nobody had come down off that hillside in a rage.',
      'I told him I was nobody’s man, which was true and was also the least useful thing I could have said. He asked what I carried. Notes, I said, and he looked at the notes. Then: “Which city pays for you?” I stood in the sun and assembled the answer in front of him, and the answer was that no city would. He turned away before I finished it. I was valued at nothing and set down like an ingot that had come out wrong.',
      'They took eleven animals and the better part of a tonne of copper, and then they took the people, and the people are the part that matters. Nobody was harmed. A dead merchant is worth nothing to anyone; a living one is worth whatever will be paid to have her back. The copper was a windfall. The people were the trade.',
      'She had chosen those hills eleven days earlier and for good reasons, which I set down at the time: water she could rely on, against a steppe road whose wells she could not. The hills also have cover. She had been setting those two things against each other for twenty-two years, and on this occasion the answer came out wrong.',
      ...
      'A dry hillside at the end of August presents as nothing whatsoever. Brown, thorny, over. It is in fact the best-provisioned larder of the entire year. Everything edible on it is small and sour and close to the ground, so it looks bare.',
  ...
  },
  {
    ...
    related: [
      { to: '/reports/four-days-of-eating-a-hillside', label: 'What happened to this caravan four days later' },
  ...
  },
  {
    ...
    figures: [
      ...
      {
        name: 'mennefer-senet', at: 8, size: 'inset',
        crop: '4 / 5', pan: [0, -4], zoom: 1.3,
    ...
    body: [
      'The god is served a hot meal every day and has never eaten one. It is carried in, set down, censed, spoken over and shut into a room by itself; some while later a man goes back in and clears the table, and that has been the day here, every day, for longer than anybody in the kitchen can put a number to. Nobody finds it strange.',
      'The cooking has to fit inside those hours and nobody in that kitchen hurries. Nakht is a wab-priest, a rank low enough that he does actual work and high enough that he is inside the wall. He is shaved smooth over his whole head and body. That is a purity requirement, and he says it is the best thing that ever happened to his cooking. He is the most precise cook I have watched anywhere. Not the best. Precise.',
      'He measures with his hands the way a scribe rules a line.',
      ...
      'I asked him whether it was not a great deal of care to take over a diner who would never taste any of it. He did not take offence and he did not reach for the answer about the reversion, which was there and which he could have had for nothing. He asked what I was doing in Mennefer. I told him I was writing down what people eat so that it would be known a long time from now. He turned the bird and thought about it for a while. Then he asked me who was going to eat the meals I wrote down. Four days on the river since, and I have the answer no nearer than I had it standing in his kitchen.',
  ...
  },
  {
    ...
    figures: [
      {
        name: 'alashiya-mortar', at: 2, size: 'inset',
      ...
      {
        name: 'alashiya-mise', at: 6, size: 'col',
      ...
      {
        name: 'alashiya-spread', at: 3, size: 'inset',
      ...
      {
        name: 'alashiya-crewman', at: 8, size: 'inset',
    ...
    standing:
      'Nobody wrote down what a ship’s crew ate. What you have is a hold. One of ours went down off Uluburun and lay on the seabed until you found her — ten tonnes of copper aboard, so she was on the leg we have not done yet — and in among it almonds, pine nuts, figs, olives, grapes, pomegranates, coriander and sumac. That is a shopping list from a working ship. The method is mine.',
    body: [
      'This ship carries exactly one fire and it lives inside a box of sand. The box is fired clay, roughly stool-sized, open across the top with a feeding hole cut in one side, and it sits amidships in a bed deep enough that nothing beneath it ever warms up. That is the sum total of the galley on a hull made of timber, flax, cordage and pitch, every one of which will accept a spark and convert nine men into an anecdote other crews tell. It gets lit late in the day. Somebody stays beside it the entire time it burns.',
      'It is dead before dark.',
  ...
  },
  {
    ...
    figures: [
      {
        ...
        caption: 'The grain is the same grain that becomes bread. Only what happens next is different.',
      },
      {
        name: 'delta-meal', at: 6, size: 'col',
      ...
      {
        name: 'delta-table', at: 0, size: 'inset',
      ...
      {
        name: 'delta-basket', at: 8, size: 'inset',
    ...
    body: [
      ...
      'She toasts with the pan tipped and her wrist going, her eyes on the doorway and not on the grain, and she takes it off at the moment, every time, and never once looks down. I do not know what she is going by. Four mornings, and I still do not know.',
  ...
  },
  {
    ...
    figures: [
      ...
      {
        name: 'hattusa-leeks', at: 7, size: 'inset',
    ...
    pulls: [
      {
        at: 3,
        text: 'A statute fixing the price of a sheep is not evidence of what sheep cost. It is evidence of a quarrel.',
      },
    ],
    standing:
    ...
    body: [
      ...
      'What is inside those walls also makes this kingdom unlike anywhere else I have shopped. Ḫatti writes its prices down. A real code sits on real tablets up that hill, stating in flat unarguable sentences what an ox is worth, what a hide is worth, what a month of a hired man is worth. A sheep sits near the bottom of that list at roughly one shekel of silver.',
      ...
      'For anyone doing this in a shop rather than a pen, the principle survives the translation: buy whatever nobody else is competing for. That means neck. Not leg. Leg is what a confident shopper reaches for and it is precisely wrong here, too lean to last three hours and dry long before it surrenders. Neck carries bone and gristle and threads of fat, all three of which have work to do, and it costs about a third as much. Thick slices, on the bone. The rest of the dish cost me almost nothing. In that market the allium baskets are the ones nobody bothers to watch. Eight big leeks to a kilo and a half of meat, in two goes, for the reason Bēltum will give you at more length downriver. The sheep makes it rich.',
      'The leeks make it a dish.',
  ...
  },
  {
    ...
    standing:
      'You will not find an Aegean recipe. Not one, anywhere, ever — because we did not write them. Every ingredient here is either counted on a Knossos tablet from the palace years or dug out of a Cretan midden — the fennel, the coriander, the celery, the oil, the wine, the olives — and nothing anywhere records anybody putting them together. The fish is not even on the tablets. That is about the scribes and not about the diet: a bream landed at Amnisos in the morning and eaten there at noon passed through no storeroom and needed no clerk. So this is a reconstruction. Amnisos is in the archive. Idaia is not, and neither is the fish she cooked me under a palace nobody has run in a hundred and fifty years. That is the entire problem with this world, and it is why I am bothering to write any of it down.',
    body: [
      ...
      'She is perhaps thirty and has firm opinions about how other people manage their fires. She can take a bream apart faster than this sentence. Her Akkadian runs to forty words or so, I have none of hers at all, and two days went by in gesture, which neither of us minded. When I put a hand out for a knife she moved the knife.',
  ...
  },
  {
    ...
    figures: [
      {
        name: 'portrait-12', at: 7, size: 'inset',
        alt:
      ...
      {
        name: 'portrait-14', at: 8, size: 'inset',
      ...
      {
        name: 'portrait-07', at: 9, size: 'inset',
      ...
      {
        name: 'landscape-13', at: 10, size: 'inset',
    ...
    body: [
      ...
      'THE AEGEAN keeps the longest list of seasonings of the five and never once says what was done with any of them. Coriander, cumin, fennel, sesame, celery, mint: those come off the tablets in the merchants’ houses outside the walls at Mycenae, and off the palace accounts at Knossos, and every one of those documents is a stock inventory and nothing else. So: how much of each went into which storeroom, to the unit. Nothing about the dish. Olive oil there is the ordinary fat rather than the expensive one, and the sheep cheese justifies the crossing on its own. Their script cannot write a final consonant and makes no distinction between l and r, so every name in Linear B is an approximate sketch of a sound. In place of instructions you get hardware: portable clay grills, notched along the top edge to seat skewers. Somebody was cooking meat on sticks over charcoal three thousand years ago and the equipment proves it even though nobody wrote it down.',
      'CANAAN AND THE COAST is home, and of the five it left the thinnest kitchen of its own. That is what a place gets for spending its whole time moving everybody else’s food. To ourselves we are knʿn. To a Babylonian clerk we are Kinaḫḫu, and in the letters that go down to Egypt we are Kinaḫni. Harbours, warehouses, other people’s cargo. Olive oil pressed at a scale that is hard to picture, wine with resin through it, a great deal of fish, and a drinking club called the marzeaḥ whose membership rolls and property holdings you can read in detail and whose menu is a blank.',
