...
export const fieldReports = [
  ...
  },
  {
    ...
    body: [
      ...
      'On the eleventh evening I said something about my feet. Šimatum let a moment go by and then offered to take eighty kilos of copper off the third donkey so that I could ride, and waited to see whether I would work out what that would cost her. I asked her instead whether she liked the road. She was looking at the frame on the third animal and did not turn round. “My husband liked the road,” she said.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      'I stayed four days with Ipuy, who grows flax and does something complicated and semi-legal with a neighbour’s cattle, and with Merit, who runs everything else and is the reason it was four days and not one. There is a child of about four whose name I never reliably caught because it changed depending on who was calling him. The house is one room and a roof over the yard. In the yard: a domed oven, a saddle quern, three storage jars, a mortar, and a low table that is also the workbench, the dining table and, at one point, a boat.',
      'The morning meal is what most Egyptians were actually eating most of the time.',
      'Cracked emmer, and a pot of water. That is the whole of it. Merit toasts the grain dry first for a couple of minutes, which she does without thinking about it and which turns out to be the entire difference between this dish and paste: untoasted it tastes of nothing, toasted it tastes of biscuit and nuts. She does it with the pan tilted and her wrist going, watching the doorway instead of the grain, and stops at the right moment every time without once looking down. Then water, salt, and twenty-five minutes at a simmer while she does four other things. At the end she beats it hard with the spoon for half a minute and it goes from grain sitting in water to something creamy, with nothing added.',
      ...
      'The other thing I would put in the record: Merit makes baskets. Coiled reed, very fast, sitting by the water in the part of the afternoon that is too hot for anything else, and they go to a man who comes through every few weeks. It is not a sideline; over a year it is a serious part of what the household lives on. The same silence covers it. You have the flax, because flax was taxed. You do not have the baskets. I told her that. I said that nothing anywhere would remember the afternoons, and that in three thousand years the flax would still be on a list somewhere and the baskets would be on nothing at all. She thought at first that I was making a joke, and then saw that I was not. “He knows,” she said, and put her chin towards the boy, who was under the table at the time, ruining a basket.',
      'I left on the fifth morning with a basket I had not asked for and did not need, and which I still have. Ipuy walked me as far as the water and told me a long story about the cattle. Merit was toasting grain and did not look up, and there was no reason on earth why she should have.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      'Idaia cooks here. I am not going to pretend I found her in an archive, because she is not in one, and neither is anybody else who has ever made a meal in this world. She is a woman of about thirty who feeds crews for a living, holds strong views about other people’s fires, and can gut a bream faster than I can describe it happening. She has perhaps forty words of Akkadian and I have none of hers, so two days were conducted mostly with our hands, which suited us both. I came away with one dish and one idea. The idea is better than the dish, and the dish is very good.',
      ...
      'And here is the idea. Idaia has no way to count minutes and no interest in acquiring one. What she has is a lyre, which lives on a hook by the door, and she plays it sitting on a stool with her back to the fire. The fish is done in two songs. Not two songs approximately, but two particular songs, the same two, every time, because she has been doing this for years and knows exactly how long they take. Then she gets up and checks the shoulder with her thumb, because she is a cook and not a mystic.',
