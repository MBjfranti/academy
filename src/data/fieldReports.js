...
export const fieldReports = [
  ...
  },
  {
    ...
    body: [
      ...
      'They had come off the slope on both sides at once, at the narrow part, and it was finished before I understood it had begun. Eight or nine men with long spears and not a raised voice among them. There was no charge and nobody resisted. Šimatum said a single sentence I did not catch and then held both hands out flat, palms towards the ground, and the two hired men did the same. They took eleven animals and four tonnes of copper, and then they took the people, and the people are the part that matters. Nobody was harmed. A dead merchant is worth nothing to anyone; a living one is worth whatever will be paid to have her back. The copper was a windfall. The people were the trade.',
      'We were in those hills because the direct road east crosses steppe, flat and exposed and by August dry enough that Šimatum did not trust the wells along it. Animals die on a dry road and a dead animal is eighty kilos of freight that somebody else now has to shoulder. So she went the long way, through hill country, where there is water. There is also cover. She had been setting those two against each other for twenty-two years, and on this occasion the answer came out wrong.',
      ...
      'What the next four days taught me is why this is a report about food and not a complaint. A dry hillside at the end of August presents as nothing whatsoever. Brown, thorny, over. It is in fact the best-provisioned larder of the entire year, and the reason it looks bare is that every edible thing on it is small and sour and low down.',
      'Sumac before anything else, because sumac is what saved me. The red drupes ripen at exactly this point in fat velvet clusters and they are sourness with nothing else attached, and you can strip them into your mouth off the standing shrub, which in a country containing no lemons is not a minor discovery. Purslane comes out of fissures in rock, holds its water through the one month when everything else has bolted and turned bitter, and carries a faint salinity. Terebinth yields a nut that is oily and resinous. Capers repay you only if you are prepared to draw the bitterness out over a full day, which on the first day I was not. Wild figs come apart on trees no one planted. Mallow is uninteresting and faintly slippery and will keep you upright. The almonds are what will hurt you, since bitter and sweet grow side by side and are indistinguishable to look at, the only signal is flavour, and the correct response to a bitter one is to spit rather than to press on politely. Oleander grows everywhere, is lovely, and is not to be handled in any state at all, the smoke off it included.',
  ...
  },
  {
    ...
    body: [
      ...
      'We move before dawn and halt when the animals have had sufficient, which arrives well before the people have had sufficient, and that gap is not a matter for discussion. The route leaves the ports going inland, meets the Euphrates and thereafter simply keeps it company, dropping down through Emar where anything travelling between the sea and the rivers changes owner, and continuing east towards the cities. Nothing about it was built. It is an agreement reached by a very large number of feet over a very long time. On the eleventh day I record that eleven days is a considerable quantity of days and that my own feet have lost all interest in the achievement.',
  ...
  },
  {
    ...
    body: [
      ...
      'He laughed for some time before answering. Then he asked whether I had ever come across a law written about something nobody argued over. I said I had not. “There it is,” he said. A statute that fixes the price of a sheep is not evidence of what sheep cost. It is evidence of a quarrel that recurred often enough for somebody in authority to lose patience with hearing it. You do not legislate agreement. And besides, he said, hardly anything in that market changes hands for silver in the first place. Silver is for treaties and for palaces. What actually moves is barley and cloth and oil, in amounts no one records, at rates that shift with the season and with how much the two of you happen to like one another. “You want the price,” he said. “I have the sheep.” Then he said something in Hittite that I do not have and he did not offer to translate, and the men at the next pen found it very funny indeed.',
  ...
  },
  {
    ...
    body: [
      ...
      'And the ships are why five kitchens amount to one world. Leave Ugarit and you can be on Cyprus inside a day and a half, on Crete inside the week. Grain comes up out of Egypt. Copper comes across from Cyprus. Oil and wine go everywhere at once in quantities nobody has ever successfully counted. Water beats land for speed, so the ports are where recipes change hands along with everything else that changes hands.',
      'MESOPOTAMIA is the one kitchen of the five that left behind anything you could call a recipe, and what it left is three tablets, the best of them carrying twenty-five entries, composed by professionals for other professionals and consequently listing no quantity and no cooking time anywhere in them. Barley country, east and downriver, in a century when Bābili has not yet come to run the region. The flavour runs sour: beer into the pot, soured milk stirred through once the heat is off, raw crushed garlic at the finish. Onions go into very nearly everything, and they will argue the point with you at length.',
