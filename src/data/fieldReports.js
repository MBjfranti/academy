...
export const fieldReports = [
  ...
  },
  {
    ...
    figures: [
      {
        name: 'robbed-taken', at: 1, size: 'col',
      ...
      {
        name: 'robbed-foraging', at: 7, size: 'inset',
      ...
      {
        name: 'robbed-teaching', at: 9, size: 'col',
    ...
    body: [
      ...
      'They had come down off the slope on both sides of the track at once, where it narrows, and it was over before I had understood that it was starting. Eight or nine men with long spears, and no shouting from anybody. They did not charge and nobody fought them. Šimatum said one sentence I did not catch, then put her hands out flat with the palms down. The two hired men did the same. That was the robbery.',
  ...
  },
  {
    ...
    figures: [
      ...
      {
        name: 'mennefer-table', at: 3, size: 'inset',
      ...
      {
        name: 'mennefer-senet', at: 6, size: 'inset',
        crop: '4 / 5', pan: [0, -4], zoom: 1.3,
    ...
    body: [
      'The god is served a hot meal every day and has never eaten one. It is carried in, set down, censed, spoken over, and left alone in a shut room. Later somebody comes back and clears the table. That is the day, every day, and it has been the day for centuries.',
      'I came upriver for the contrast and got more of it than I bargained for. Last week I was in a one-room house in the Delta watching a woman boil cracked grain for her family. This week I am in a temple kitchen at Mennefer watching four men prepare a meal, with great care and no hurry, for somebody who is not going to eat it. Mennefer is an old capital and an enormous working town, and behind it on the desert edge are the pyramids, which are not new. They are about twelve hundred years old. The people who built them are as far back from the priests I met this week as those priests are from you. Everyone here treats them the way you treat a mountain, as scenery with a bit of history on it.',
      'Nakht is a wab-priest, which is a rank low enough that he does actual work and high enough that he is inside the wall. He is shaved smooth over his whole head and body, which is a purity requirement and which he says is the best thing that has ever happened to his cooking. He is the most precise cook I have watched anywhere. Not the best. Precise. He measures with his hands the way a scribe rules a line.',
      'What goes on the table on the day I am there: a roasted bird, a bowl of pulses with green herbs over them, bread in two shapes, dates, figs, onions, a jar of beer and a jar of wine. It is a good meal by any standard. It is also, and this took me a while to see, arranged rather than served. The bird whole and glazed dark, the loaves stacked, the greens laid around the edge. It is composed to be looked at, because the first thing that happens to it is that a man sets it down in front of a statue and steps backwards out of the room.',
      ...
      'Then the reversion, which is my favourite fact in Egypt. The god does not consume the offering, and the offering is not thrown away or burnt. It comes back out and is divided among the priests, the singers, the doorkeepers, and the people who carried it in. A temple is a religious institution and it is also, in strictly practical terms, an extremely large catering operation with a very unusual first customer. The offering table is the point at which the whole economy of a temple turns back into dinner.',
      'I said to him, more or less, that it was a great deal of care to take over a diner who was never going to taste any of it. He did not take offence, which I had half expected him to, and he did not give me the answer about the reversion either, though he could have. He asked what I was doing in Mennefer. I told him I was writing down what people eat so that it would be known a long time from now. He turned the bird and thought about it. “You write meals nobody will remember,” he said. “I cook meals nobody eats.” Then he asked me where the difference was. I have been four days on the river since and I still have not got a good answer.',
      'I ate some of it and it was excellent. Nakht ate rather more of it than I did, then went and sat on a mat and played senet against himself, which is what the middle of the day is for. “I usually win,” he said.',
    ],
  },
  {
    ...
    figures: [
      {
        name: 'alashiya-mortar', at: 0, size: 'inset',
    ...
    body: [
      'There is one fire on this ship and it lives in a box. Fired clay, roughly the size of a large stool, open at the top with a hole in the side to feed it and a small charcoal fire inside, sitting amidships in a bed of sand. That is the entire cooking apparatus of a vessel built from wood, linen, rope and pitch, any of which will take a spark and turn nine men into a story other sailors tell. Nobody aboard is relaxed about it. It is lit late, it is watched the whole time, and it goes out before dark.',
      'We are nine days down the Cilician shore and have not lost sight of land once. I mention it because when somebody says a ship you picture open water and no horizon, and a man staring at the sky doing something clever with stars. We do almost none of that. We go down the coast the way a cart goes down a road, with land on the left hand all day, a beach or a river mouth to put into before dark, and off again at first light. Nine days of it, and I could have walked the whole way along the beach, slowly, and got there.',
      ...
      'The cooking is designed backwards from the box, and the design is severe. One pot, because there is one heat. Nothing needing two temperatures at once. Nothing needing a long boil, because charcoal is cargo too. Abdi does the cooking, because he is the youngest and lost the argument years ago, and what he makes is chickpeas, soaked overnight, cooked soft, then oil and onion and cracked coriander in and the whole thing reduced until it is thick rather than wet. Half of it crushed against the side of the pot, half left whole. Then it goes hot onto flatbread spread with cold curd, olives and torn herbs over the top, oil across the lot. You eat it standing. Everyone eats it standing. I said something to him about the elegance of a kitchen built around a single heat. He went on stirring. “You get off at Ugarit,” he said. It was not a question. I told him I was not getting off at Ugarit, and he looked at me for a moment and then went back to the pot, and was a good deal friendlier for the rest of the run.',
  ...
  },
  {
    ...
    body: [
      'I went up to Ḫattuša for a sheep, which is not as simple as it sounds. A sheep in a pen is mostly wool, and wool is an excellent way of hiding an animal from the person buying it, so you get down on your heels and put a hand in over the loin and the shoulder, where the meat is, and feel what is under there instead of looking at what is on top. Thin over the spine and you are buying bone and disappointment. The man selling this one was called Zuwa: about sixty, built like a storage jar, grey to the chest, and entirely delighted to watch a Ugaritic clerk fumble around in a fleece.',
      'The city is high, and you feel it before you see it. The road climbs for two days out of the plain and the air thins and sharpens as it goes, and then there are walls on a ridge that were built by people who had decided, very firmly, that nobody was coming in. The market sits outside them, in the dust below the gate, which is where markets always sit. Inside is the archive and the temples. Outside is where anything actually changes hands.',
      'Here is what makes Ḫatti different from anywhere else I have bought food. This kingdom writes its prices down. The Hittite Laws — a real code, on real tablets, in the archive up the hill — fix what things are worth in silver, and they do it in flat declarative sentences. So much for an ox. So much for a hide. So much for a month of a hired man. And a sheep, among the cheapest animals on the list, at about a shekel.',
      'I quoted this at Zuwa. I knew exactly what I was doing and did it anyway.',
      'He laughed for a good while first. Then he asked whether I had ever seen a law written about something nobody argued over. I said I had not. “There it is,” he said. A statute fixing the price of a sheep is not a report of what sheep cost; it is a report of a quarrel that happened often enough that somebody in authority got tired of hearing it. Nobody legislates a thing everyone already agrees on. And in any case, he said, almost nothing here is bought with silver at all. Silver is for treaties and for the palace. What actually moves is barley, cloth and oil, in quantities nobody writes down, at rates that shift with the season and with how much the two of you like each other. “You want the price,” he said. “I have the sheep.” He said something after that in Hittite, which I do not have, and did not translate it. The men at the next pen enjoyed it considerably. I paid in barley, I paid more than a shekel, he offered me a goat twice and I declined twice, and both of us went away satisfied.',
  ...
  },
  {
    ...
    figures: [
      ...
      {
        name: 'cretan-fish-stuffing', at: 5, size: 'inset',
        crop: '4 / 5', pan: [0, 0], zoom: 1,
      ...
      {
        name: 'cretan-fish-smoke', at: 6, size: 'inset',
      ...
      {
        name: 'cretan-fish-plate', at: 8, size: 'col',
    ...
    body: [
      ...
      'She works at Amnisos, which is the harbour Knossos uses. Used, rather, which is the first thing to say about the place. The great palace up the hill burned generations before I was born and nobody put it back, and what stands there now is a very large ruin with people living around the edges of it. What stands at the bottom is a working harbour, because a good beach does not stop being a good beach when the accountants leave: a stretch of sand you can pull a boat onto, a row of houses facing the wrong way to catch the wind, and the smell of fish being gutted at speed by about nine in the morning. The scribes wrote it a-mi-ni-so, back when there were scribes. It is on their tablets because ships and cargo are on tablets. Nothing else about the place is.',
      'I am not going to pretend I found her in an archive, because she is not in one, and neither is anybody else who has ever made a meal in this world. She is a woman of about thirty who feeds crews for a living, holds strong views about other people’s fires, and can gut a bream faster than I can describe it happening. She has perhaps forty words of Akkadian and I have none of hers, so two days were conducted mostly with our hands, which suited us both. I came away with one dish and one idea. The idea is better than the dish, and the dish is very good.',
      'Start with the fish, because she does. She wants them whole and about the length of her forearm — half a kilo each, near enough — and she picks them with the eye clear and the gills red underneath, which is advice that has not changed in three thousand years and is not going to. Two of that size feed four people. When I reached for a knife to open one out flat she took the knife off me without comment. Everything good about this dish happens because the fish is cooked on the bone with its belly full of something.',
      ...
      'She chops the fronds together with coriander leaf, celery leaf and garlic crushed to a paste, salts the heap, and then works it with her hands for noticeably longer than seems necessary. I asked why. “Green,” she said. “Not grass.” When it was clear I had not understood she took my wrist, put my hand into the bowl and held it there until I did. There is a difference between herbs sitting inside a fish and herbs having done something to it, and all of it is in the smell. Then she scores each fish twice a side, down to the bone, and packs the belly until it will not take any more.',
  ...
  },
  {
    ...
    body: [
      ...
      'So I went and looked. Merchant ships to Cyprus and across to the Aegean. South into Egypt, where the bread is better than anyone north of it will admit. North with the caravans into Hatti. East, eventually, to sit in Babylonian kitchens and be told at length that I was wrong about onions. “You put them in at the beginning,” a woman in Sippar told me, twice, in the voice you would use on a slow child. “They are not a decoration.” I ate with sailors, shepherds, soldiers, bakers and dockworkers, because those are the people who cook, and because a palace will feed you well exactly once and then want something.',
  ...
  },
  {
    ...
    body: [
      'Start with the sea, because everything else follows from it. A ship leaving Ugarit can be in Cyprus in a day and a half and on Crete inside a week. Grain comes north out of Egypt, copper comes east off Cyprus, and oil and wine move in every direction at once in quantities nobody can keep track of. This is one world instead of five because the water is faster than the land, and the ports are where food ideas change hands along with everything else.',
      ...
      'EGYPT eats better bread than the rest of us and knows it. Emmer wheat baked in tall clay moulds, and a beer thick enough to count as food, and those two things frame the day from one end to the other. Waterfowl and Nile fish for protein, dates and tiger nuts for sweetness. The country calls itself Kmt, the black land, after the silt the flood leaves behind and against the red desert either side of it, and everyone else calls it something like Miṣru. Nothing of theirs reaches you as a recipe. They painted their kitchens on their tomb walls instead, which is its own kind of record.',
      'ḪATTI is obsessed with bread and will not tell you how to make any of it. Their texts name well over a hundred kinds and explain almost none. It is cold country, high on the Anatolian plateau, with an archive at Ḫattuša that runs to tens of thousands of tablets. The thing that marks their cooking out is sweetness against meat, which nobody east of them does: there is a dish that bakes lamb in olive oil and honey together and it is better than it sounds. Good hazelnuts. And chickpeas mashed with cucumber over the top, which I have never met anywhere else.',
      'THE AEGEAN keeps the longest spice list of the five and never once says what it did with any of it. The palace records at Knossos and Pylos are inventories, so you know exactly how much coriander went where and nothing whatever about the dish it went into. Olive oil is the default fat there rather than a luxury, and the sheep cheese is worth crossing water for. Their two great archives are ko-no-so and pu-ro, written in a syllabary that cannot spell a final consonant and does not distinguish l from r, so every Linear B name is a rough sketch of a sound. What you have instead of instructions is the equipment. Portable clay grills, with notches cut along the top to seat skewers. Somebody was grilling meat on sticks over charcoal three thousand years ago and the hardware proves it.',
      'CANAAN AND THE COAST is mine, and it left less of a kitchen of its own than any of the others. That is what you would expect of a place that spent its whole time moving everyone else’s food. We are knʿn to ourselves, Kinaḫḫu to a Babylonian clerk, Kinaḫni in the letters to Egypt. Ports, warehouses, other people’s cargo. Olive oil at industrial scale, wine with resin in it, fish, and a drinking society called the marzeaḥ whose paperwork you hold in detail and whose menu you do not have at all.',
