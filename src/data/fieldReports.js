...
export const fieldReports = [
  ...
  },
  {
    ...
    body: [
      '“Whose man are you?” Their leader had better Akkadian than mine. I had not expected that, and it told me most of what I needed to know about the afternoon: these were not men who had come down off a hill in a temper.',
      'I said I was nobody’s, which was true and was also the worst answer available. He asked what I was carrying. I said notes, and he looked at the notes. Then: “Which city pays for you?” I stood there in the sun working it out in front of him, and the honest answer was none of them. He had moved on before I finished, having asked the question only in order to arrive there. I was not spared out of mercy. I was assessed at nothing and set down like a bad ingot.',
      'They had come down off the slope on both sides of the track at once, where it narrows, and it was over before I understood that it was starting. Eight or nine men with long spears, and no shouting from anybody. They did not charge and nobody fought them. Šimatum said one sentence I did not catch, then put her hands out flat with the palms down. The two hired men did the same. They took the eleven donkeys, and the four tonnes of copper, and then they took the people, which is the part that matters. Nobody was hurt. A dead merchant is worth nothing to anybody; a live one is worth whatever somebody will pay to get her back. The copper was a bonus. The people were the asset.',
      'We were in those hills because the direct road east runs across steppe, flat and open and in August dry enough that Šimatum did not trust the wells. You can lose animals on a dry road, and a dead donkey is eighty kilos of cargo that somebody else now has to carry. So she took the long way round through the hill country, where there is water. There is also cover. She had been weighing those two things against each other for twenty-two years and this time the sum came out wrong.',
      ...
      'What I learned over the four days that followed is the reason this is a food report and not a complaint. A dry hillside in late August looks like nothing. Brown, spiny, finished. It is in fact the best-stocked larder of the year, and it looks empty only because everything on it is small, sour and close to the ground.',
      'Sumac first, because sumac saved me. The red drupes are ripe now in fat velvety clusters and are pure sourness, and you can chew them straight off the shrub, which in a landscape with no lemon in it is not a small thing. Purslane grows out of cracks in the rock, stays fat with water in the exact month everything else has gone to seed, and tastes faintly of salt. Terebinth gives an oily, resinous nut. Capers are worth having only if you will soak the bitterness out of them for a day, which on the first day I would not. Wild figs split open on trees nobody planted. Mallow is dull and slightly slimy and will keep you alive. Almonds are the ones that will hurt you: bitter and sweet grow on the same hillside and look identical, the only warning is the taste, and if it is bitter you spit it out rather than persevering. Oleander is everywhere, is beautiful, and must not be touched in any form whatever, including the smoke off it.',
      'On the fourth morning I came over a saddle and found sheep, and behind the sheep two people and a fire. A girl of about sixteen and her grandfather, three days from anywhere, working a flock across the high ground while the low pasture was burnt off. I had assumed I would be a beggar at that fire and instead I turned out to be the one with something to give. They were shepherds and not gatherers. Their food came off the flock, milk and curd and hard bread carried up from below, and they had walked past that sumac every day of their lives without once thinking about it.',
      'So I emptied the basket out on the rock and went through it a pile at a time. The girl made me do the whole thing again from the beginning, and by the end she was correcting me about where the good fig trees were. “Not that one,” she said, of a tree I had been rather pleased with. “That one is for the birds.” Which was fair enough. She lives there and I do not. What we made was purslane raw and mallow softened for a minute and wrung out, both folded through their soured milk with salt and a hard pour of oil, sumac over the top until the whole surface went pink, cracked terebinth, figs torn open, hard bread to scoop with. Sour, then salty, then briefly sweet wherever a fig is. It cost nobody anything at all. Four days earlier I had been eating out of the stores of a caravan carrying four tonnes of copper, and this was better, and I am going to leave that where it is.',
      'Word came up to the shepherds on the sixth day, the way word does. The town below the pass had paid, not out of kindness but out of exposure. A city is answerable for what happens to merchants on its ground, and Šimatum was carrying somebody else’s copper under somebody else’s seal, so if she vanished in their hills the letters would start: first from her partners, then from her city, then from a king. A claim of that kind gets settled in silver whatever the town admits to. The headman paid, and will spend the next two years getting it back off the road in tolls. That is not a moral system. It is a working one, and it is why the copper road exists.',
      'They came out yesterday, all five of them, without donkeys or copper, and Šimatum reportedly in a temper of legendary proportions about the third pack-frame rather than about the cargo. Anybody who has walked eleven days behind her will find that entirely in character. She is going down to the coast to file the loss and start again. I have not stopped noticing that a town paid good silver for five people and would not have paid a shekel for the sixth, who was standing in front of them at the time. I am going east on my own feet, and I am taking a basket.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      'Šimatum checks the third pack-frame twice a day. Once in the dark before the animals are loaded, running her thumb along the inside of the near arm, and once at the far end when everything comes off again. She has done it every day for eleven days and she will not say what she is looking for. On the fourth morning I asked and she said the frame was fine, which was not an answer to the question, and by the ninth I had stopped asking.',
      'There are eleven donkeys and five people. Šimatum runs it and has run it for twenty-two years, since her husband did it and then stopped being able to. She is somewhere past fifty and wrapped against the dust in a blue-grey mantle that cost more than everything I own, and she can look at an animal across a field and tell you what it is worth and what is wrong with it. The others are her nephew, two hired men and a boy. I am the sixth and I am cargo, which nobody has said and everybody knows.',
      'We start before light and stop when the animals have had enough, which is earlier than when the people have had enough, and the difference is not up for discussion. The road runs inland from the ports, finds the Euphrates and then simply follows it, down through Emar where everything crossing between the sea and the rivers changes hands, and on east toward the cities. It is not a road in the sense of a built thing. It is a habit a great many feet have agreed on. On the eleventh day I would like to record that eleven days is a great many, and that my feet have stopped finding any of it interesting.',
      'The argument at the well on the sixth day is the one worth writing down. A man there wanted more for fodder than Šimatum thought fodder was worth, and she stood in front of him and did it out loud. An animal carries eighty kilos. It walks twenty-five kilometres in a day. It eats whether it is loaded or empty, so the feed either rides with you and takes up load, or it gets bought at whatever price a man beside a well decides on this particular morning. She told him which of those she was choosing and what it made his water worth, and then she waited. He came down. Afterwards she said, without any particular feeling, that everything else on a road is talking.',
      'The load is copper. Oxhide ingots, the same four-horned slabs I watched come off a ship on the coast a fortnight ago, and it is easy to talk about a trade route as though it were one thing. It is not. It is a sea leg and a land leg with a town in between whose entire purpose is the handover, and the cost structure of the two halves is so different that they may as well be separate trades. Copper clears the ratio easily. Tin clears it. Cloth clears it, which is why textiles turn up in merchant letters far more than you would expect of something so unglamorous. Grain does not clear it and never has, because by the time you have fed the animals carrying grain three hundred kilometres you have eaten a serious fraction of the grain. That is why the sea wins whenever the sea is available, and why the inland cities are hungry for exactly the things a ship cannot reach them with.',
      'What comes off the donkeys at the end of a day is a short and strange list. Cracked grain, dried pulses, oil in a sealed jar, salt, dried fruit, and a hard grey object that took me three days to identify. It is milk. It has been fermented, drained, salted, pressed into a shape and dried until you could hit somebody with it. Break a piece into warm water and twenty minutes later you have something between yoghurt and cheese. It is a way of carrying a dairy herd in a saddlebag, it is the cleverest thing I have met on this journey, and by the eleventh evening I was tired enough to resent it.',
      'The pot is the boy’s job and he is not bad at it. Onions cooked slowly in oil with cumin while the animals are watered, cracked grain turned through the oil until it is coated, water, twenty-five minutes. Then the pot comes off the fire entirely before the soaked curd goes in, because sour dairy splits if it boils and a split pot at the end of eleven hours is a real misfortune. Torn dried apricots at the very end. Salt. It is sour and deep and a great deal better than a bag of dry goods has any business producing, and every single person had an opinion about it, all of them different, all delivered with force.',
      'I said something about my feet. Šimatum let a moment go by and then offered to take eighty kilos of copper off the third animal so that I could ride, and waited to see whether I would work out in front of her what that would cost. I did, eventually. She watched me do it.',
      'So I asked her instead whether she liked the road. She was looking at the frame on that third animal and did not turn round. “My husband liked the road,” she said, and went to check the near arm again with her thumb.',
    ],
  },
  {
    ...
    body: [
      ...
      'I also said to him, more or less, that it was a great deal of care to take over a diner who was never going to taste any of it. He did not take offence, which I had half expected, and he did not reach for the answer about the reversion either, though he could have. He asked what I was doing in Mennefer. I told him I was writing down what people eat so that it would be known a long time from now. He turned the bird and thought about it. “You write meals nobody will remember,” he said. “I cook meals nobody eats.” Then he asked me where the difference was. I have been four days on the river since and I have not got a good answer.',
      'Behind this town, on the desert edge, are the pyramids, and they are not new. They are about twelve hundred years old. The people who built them are as far back from Nakht as Nakht is from you, and everybody here treats them the way you treat a mountain, as scenery with some history on it. He ate rather more of the bird than I did, then went and sat on a mat and played senet against himself, which is what the middle of the day is for. “I usually win,” he said.',
    ],
  },
  {
    ...
    body: [
      'There is one fire on this ship and it lives in a box of sand. Fired clay, about the size of a large stool, open at the top with a feed hole in the side, sitting amidships in a bed deep enough that nothing under it ever gets warm. That is the entire cooking apparatus of a vessel built from wood, linen, rope and pitch, any of which will take a spark and turn nine men into a story other sailors tell. It is lit late, it is watched the whole time it is alight, and it goes out before dark.',
      'Everything anyone eats on this run is decided by that box. One pot, because there is one heat. Nothing that needs two temperatures at once. Nothing that needs a long boil, because charcoal is cargo and cargo is the point of the voyage. Abdi does the cooking, on the grounds that he is the youngest and lost an argument about it years ago, and what he makes is chickpeas: soaked overnight, cooked soft, then oil and onion and cracked coriander through them and the whole thing reduced until it is thick and not wet. Half crushed against the side of the pot, half left whole.',
      'It goes hot onto flatbread spread with cold curd, with olives and torn herbs over the top and oil across the lot, and everybody eats it standing. The reason it is better than that list suggests is that hot and cold are touching. The curd slackens where the chickpeas land on it and you get a third texture between the two that neither has on its own. Nobody designed that. It is what happens when a man has one pot and no choices.',
      'I said something to him about the elegance of a kitchen built around a single heat. He went on stirring. “You get off at Ugarit,” he said. It was not a question. I told him I was not getting off at Ugarit, and he looked at me for a moment and then went back to the pot, and was a good deal friendlier for the rest of the run.',
      'Which brings me to the thing I have not said yet, which is that we have been nine days at sea and have not lost sight of land once. I mention it because when somebody says a ship you picture open water and no horizon and a man doing something clever with stars. We do almost none of that. We go down the coast the way a cart goes down a road, land on the left hand all day, a beach or a river mouth to put into before dark, off again at first light. Nine days of it, and I could have walked the whole way along the beach, slowly, and got there.',
      'There is nothing timid about it. A coast is a handrail. It tells you where you are, it gives you somewhere to run to when the weather turns, and it puts a market within reach every single night, which is why the food aboard is better than you would expect: half of what goes in that pot was bought off a beach that morning. Let go of the coast and you lose all three at once, along with every advantage a ship has over a donkey. What we are carrying, incidentally, is not copper but the price of copper, which is a different thing, because nobody puts copper on a ship going TO Alašiya. Jars of oil, bales of cloth, a quantity of tin, and silver by weight in a box the captain sleeps on top of and does not discuss. The heavy leg is the one home.',
      'Two more days and we raise Ugarit, which is my own city and where the handrail runs out. Alašiya lies off to the west with nothing at all in between, a day and a half of open water if the wind is reasonable and a good deal longer if it is not. It is the one crossing on this whole run and everybody has been quieter about it than about anything else in nine days. Abdi is already cooking tomorrow’s food tonight. I asked whether he minded the crossing. He said the box would not be lit out there because there was no beach to run to, so it had to be done now. That was the whole of his answer and I did not ask again.',
    ],
  },
  {
    ...
    body: [
      'The table in the yard is a plank laid across two mud-brick piers, and in four days I watched it used as a workbench, a dining table, a place to sort flax, a bed for a sleeping child, and, for most of one afternoon and with total conviction, a boat. The boat was the work of a child of about four whose name I never reliably caught, because it changed depending on who was calling him and how much trouble he was in.',
      'His father is Ipuy, who grows flax and does something complicated and semi-legal with a neighbour’s cattle that I did not entirely follow and was not entirely meant to. His mother is Merit, who runs everything else, and who is the reason it was four days and not one. The house is one room. Everything that matters happens in the yard, which has a domed oven, a saddle quern, three storage jars, a mortar, and the table.',
      'This is not the Egypt you have in your head. There are no cliffs here and no desert edge a stone’s throw away. There is flat wet green in every direction, cut into a thousand pieces by water, and so many birds that the noise takes a full day to stop registering. The villages sit up on their own rubbish a few feet above the flood, mudbrick going soft at the corners. Nobody in this village has seen a pyramid. Several people asked me what one was.',
      'What they eat in the morning is cracked emmer and a pot of water, and that is the whole of it. Merit toasts the grain dry first for a couple of minutes, which is the entire difference between this dish and paste: untoasted it tastes of nothing, and toasted it tastes of biscuit and nuts. Then water, salt, and twenty-five minutes at a simmer while she does four other things. At the end she beats it hard with the spoon for half a minute and it turns from grain sitting in water into something creamy, with nothing added to it at all.',
      'She does the toasting with the pan tilted and her wrist going, watching the doorway instead of the grain, and she stops at exactly the right moment every time without once looking down. I have thought about that more than the dish deserves.',
      'On top goes a soft heap of fresh curd, not stirred in. Sliced green onion, tops included. A handful of whatever green herb is going. Two dates per bowl, torn, as punctuation and not as sweetness. And a hard pour of oil over the lot. Everyone stirs their own. The child’s is stirred for him and he objects to this every morning, on principle, and eats all of it.',
      'You will have read that Egypt ran on bread and beer, and it did, and the phrase does a great deal of quiet damage. It makes those sound like the only two things grain became. They are the two things grain became WHEN SOMEBODY WAS COUNTING. Bread and beer are what an institution issues. They are portioned, they are countable, they keep long enough to hand out, and so they are what appears in the accounts and the ration lists and on the tomb walls where a man’s provision for eternity is itemised like a delivery note. Nobody ever had to account for breakfast. It is made from grain the household already has, by a person nobody is paying.',
      'Merit also makes baskets. Coiled reed, very fast, sitting by the water in the part of the afternoon that is too hot for anything else, and they go to a man who comes through every few weeks. It is not a sideline. Over a year it is a serious part of what this household lives on, and the same silence covers it exactly: you have the flax, because flax was taxed, and you do not have the baskets. I told her so. I said that nothing anywhere was going to remember the afternoons, and that in three thousand years the flax would still be on a list somewhere and the baskets would be on nothing at all. She thought at first that I was making a joke. Then she saw that I was not. “He knows,” she said, and put her chin towards the boy, who was under the table at the time, ruining a basket.',
      'I left on the fifth morning with a basket I had not asked for and did not need, and which I still have. Ipuy walked me as far as the water and told me a long story about the cattle that I understood perhaps half of. Merit was toasting grain and did not look up, and there was no reason on earth why she should have.',
    ],
  },
  {
    ...
    body: [
      'The trick with a sheep in a pen is that a sheep in a pen is mostly wool, and wool is an excellent way of hiding an animal from the person buying it. So you get down on your heels and put a hand in over the loin and the shoulder, where the meat is, and feel what is under there instead of looking at what is on top. Thin over the spine and you are buying bone and disappointment. The man selling this one was called Zuwa, about sixty, built like a storage jar and grey to the chest, and he was entirely delighted to watch a Ugaritic clerk fumble around in a fleece.',
      'I had come up to Ḫattuša for the archive and stayed for the market. The city is high and you feel it before you see it: the road climbs for two days out of the plain, the air thins and sharpens as it goes, and then there are walls on a ridge built by people who had decided, very firmly, that nobody was coming in. The market sits outside them in the dust below the gate, which is where markets always sit. Inside is the archive and the temples. Outside is where anything changes hands.',
      'And what is inside the archive is the thing that makes Ḫatti different from anywhere else I have bought food. This kingdom writes its prices down. The Hittite Laws are a real code, on real tablets, up that hill, and they fix what things are worth in silver in flat declarative sentences. So much for an ox. So much for a hide. So much for a month of a hired man. And a sheep, among the cheapest animals on the list, at about a shekel.',
      'I quoted this at Zuwa. I knew exactly what I was doing and did it anyway.',
      'He laughed for a good while first. Then he asked whether I had ever seen a law written about something nobody argued over. I said I had not. “There it is,” he said. A statute fixing the price of a sheep is not a report of what sheep cost; it is a report of a quarrel that happened often enough that somebody in authority got tired of hearing it. Nobody legislates a thing everyone already agrees on. And in any case, he said, almost nothing here is bought with silver at all. Silver is for treaties and for the palace. What moves is barley, cloth and oil, in quantities nobody writes down, at rates that shift with the season and with how much the two of you like each other. “You want the price,” he said. “I have the sheep.” He added something in Hittite, which I do not have and which he did not translate, and the men at the next pen enjoyed it considerably.',
      'I paid in barley. I paid more than a shekel. He offered me a goat twice and I declined twice, and we both went away satisfied.',
      'If you are buying this in a shop rather than out of a pen, the same principle holds in a different form: buy the part of the animal nobody is competing for. Neck. Not leg, which is what the confident shopper buys and is exactly wrong here, too lean to survive three hours and dry long before it goes tender. Neck has bone and gristle and fat running through it, all three of which are doing work, and it costs about a third as much. Ask for it in thick slices, on the bone. The other half of the dish cost me nothing worth mentioning. Leeks, onions, a head of garlic. In every market between here and the sea the allium baskets are the ones nobody bothers to guard, and this pot is built on them and not on the sheep: eight big leeks to a kilo and a half of meat, half going in early to dissolve into the broth and half going in late to stay green and taste of themselves. The meat makes it rich. The alliums make it a dish.',
      'One more thing, and then the pot. Zuwa keeps a lyre by his stool and plays it between customers, which he does well and knows he does well. I have met exactly one other person in this trade who keeps an instrument within reach of the work, a cook at Amnisos who uses hers to time a fish at two songs to the finish and will not be argued out of it. I asked Zuwa what he times with his. He looked at me as though I had asked what he weighs the wind with, and said he plays it because a sheep market is four fifths waiting and he had given some thought to how to spend that. Not everything is a method. I walked out of Ḫattuša with an armful of leeks I could barely see over.',
    ],
  },
  {
    ...
    body: [
      'Idaia has no way to count minutes and no interest in acquiring one. What she has is a lyre, which lives on a hook by the door, and she plays it sitting on a stool with her back to the fire. The fish is done in two songs. Not two songs approximately, but two particular songs, the same two, every time, because she has been doing this for years and knows exactly how long they take.',
      'She feeds crews at Amnisos, the harbour Knossos uses. Used, rather. The great palace up the hill burned generations before I was born and nobody put it back, and what stands there now is a very large ruin with people living around the edges of it. What stands at the bottom is a working harbour, because a good beach does not stop being a good beach when the accountants leave. A stretch of sand you can pull a boat onto, a row of houses facing the wrong way to catch the wind, and the smell of fish being gutted at speed by nine in the morning.',
      'She is about thirty, holds strong views about other people’s fires, and can gut a bream faster than I can describe it happening. She has perhaps forty words of Akkadian and I have none of hers, so two days were conducted mostly with our hands, which suited us both. When I reached for a knife to open a fish out flat she took the knife off me without comment.',
      'She wants them whole and about the length of her forearm, half a kilo each or near enough, and she picks them with the eye clear and the gills red underneath, which is advice that has not changed in three thousand years and is not going to. Two of that size feed four people. Everything good about the dish happens because the fish stays on the bone with its belly full of something.',
      'The something is fennel, which grows wild along this coast right down to where the sand starts, tall and feathery and smelling of aniseed the moment you crush it. She uses all of it. The bulb goes underneath, sliced thick, in one layer. The fronds are chopped fine with coriander leaf, celery leaf and garlic crushed to a paste, salted, and then worked with her hands for noticeably longer than seems necessary. I asked why. “Green,” she said. “Not grass.” When it was clear I had not understood, she took my wrist, put my hand into the bowl and held it there until I did.',
      'Then she scores each fish twice a side, down to the bone, and packs the belly until it will not take any more. There is no oven anywhere in this. The dish is a wide shallow clay platter that goes straight over the embers, and the one move worth stealing from the whole business is what she does with the wine: it goes around the outside and never over the skin. Liquid on top steams the fish and you lose the skin. Liquid underneath steams the fennel while the skin stays dry enough to blister. Oil across, salt on the outside, and then she picks up the lyre.',
      'The Knossos scribes counted fennel out by the unit under the name ma-ra-tu-wo, which is the same word that gave Marathon its name: the field of fennel. I told her that, badly and at some length, along with the fact that her harbour is on those tablets as a-mi-ni-so, and that this is how I know anything at all about where I am standing. She let me finish. Then she asked whether the palace had burned. I said it had, a long time ago. “And the fish is still good,” she said, and went to get the olives.',
      'It came off the fire cleaner than the ingredient list suggests. The bulb underneath had gone sweet and silky and caught a little at the edges, and the raw fronds inside had stayed sharp and perfumed the flesh from within. Olives over at the end and a hard pour of oil at the table, which is what stops the whole thing being polite.',
      'The only way to ruin it is to cook it by a clock instead of by the fish. Go by the shoulder lifting cleanly off the bone, and start looking earlier than you think you need to. Or get a lyre and learn two songs, which is the same instruction in a form Idaia would recognise. She got up at the end of the second one, put her thumb on the shoulder, and did not need to.',
    ],
  },
  {
    ...
    figures: [
      ...
      {
        name: 'portrait-06', at: 3, size: 'inset',
        alt:
    ...
    body: [
      'You have my handwriting. Not much of it, and none of the parts I would have chosen, but it is down there. Twelve years of jars into a palace store at Ugarit and jars out again: how many, whose seal, which ship, what was short. When the city burned, the tablets went into the ground and baked, which is why you have them and why you have almost nothing else. From my hand you now know precisely how much sesame oil moved through one storeroom in one bad year. You know nothing whatever about what anybody had for supper.',
      'That gap is the reason for all of this. I could have told you the quantity of every commodity that came through the port and not one thing about what happened to it after it left the door. Somebody was cooking all of it. Nobody was writing that part down, including me, for twelve years, while thinking of myself as a man who was good at his job.',
      'So I went and looked. Merchant ships to Cyprus and across to the Aegean. South into Egypt, where the bread is better than anyone north of it will admit. North with the caravans into Hatti. East, eventually, to sit in Babylonian kitchens and be told at length that I was wrong about onions. “You put them in at the beginning,” a woman in Sippar told me, twice, in the voice you would use on a slow child. “They are not a decoration.”',
      'I ate with sailors, shepherds, soldiers, bakers and dockworkers, because those are the people who cook, and because a palace will feed you well exactly once and then want something.',
      'Kings leave inscriptions. Cooks leave dinner. The inscriptions last and the dinner does not, which is why every account of this world is thick with temples and tribute lists and nearly empty of food. That is an accident of what survives being written down, and not a description of what mattered to anybody living in it.',
      'This site is my attempt at the other half. Real dishes where a text exists, and where it does not, a reconstruction that says so in the recipe and not in a footnote. What to buy in a modern shop and what to leave on the shelf. What the food actually does to a person who eats it. And a standing objection to the idea that everyone before about 1500 AD lived on grey porridge and resignation.',
      'On method, because you are going to want to know how much of this is guesswork. You know we had barley. You know we had onions. You know we had sheep. Anyone who tells you precisely what a Babylonian ate on a given Tuesday is selling something, and I say that as somebody who was there and still could not tell you. Where a tablet is clear I will say so. Where it is broken, or the plant is one you have never managed to identify, or the method is mine in period clothing, I will say that too, in the recipe, where you can act on it.',
  ...
  },
  {
    ...
    body: [
      'The chart above is mine, cut in my own hand, and you will not be able to read a word of it. That is fair, because it was not drawn for you. The wavy scoring is water. The three ringed circles are the places I keep going back to: Ugarit on the coast, Mari up the first river, Bābili a long way down the second. The dashed line running east out of Ugarit is the road, and there is a caravan on it somewhere in these pages. The little wedge marks are the names.',
      'Names are worth a moment, because you can read the routes off them. My city is ủgrt to the people who live in it and Ugarit to every scribe writing to us in Akkadian, which is the language everybody does business in whether or not they speak it at home. Crete is ke-re-te on a Linear B tablet at Knossos, Keftiu to an Egyptian painting tribute-bearers on a tomb wall, and Kaptara to a Babylonian who has almost certainly never seen it. Four names, four scripts, one island. A name only travels that far if the ships do.',
      'And the ships are the whole reason this is one world instead of five. A ship leaving Ugarit can be in Cyprus in a day and a half and on Crete inside a week. Grain comes north out of Egypt, copper comes east off Cyprus, and oil and wine move in every direction at once in quantities nobody can keep track of. The water is faster than the land, and the ports are where food ideas change hands along with everything else.',
      'MESOPOTAMIA is the only one of the five that left you anything resembling a recipe, and it left you three tablets, twenty-five entries on the best of them, written by professionals for professionals and therefore carrying no measurement and no cooking time anywhere. It is barley country, east and downriver, where Bābili is still a few generations short of running the region. The register is sour. Beer goes in the pot, soured milk is stirred through off the heat, raw crushed garlic goes in at the end. And onions in more or less everything, which they will defend at length.',
      'EGYPT eats better bread than the rest of us and knows it. Emmer wheat baked in tall clay moulds, and a beer thick enough to count as food, and those two frame the day from one end to the other. Waterfowl and Nile fish for protein, dates and tiger nuts for sweetness. The country calls itself Kmt, the black land, after the silt the flood leaves behind and against the red desert either side of it, and everyone else calls it something like Miṣru. Nothing of theirs reaches you as a recipe. They painted their kitchens on their tomb walls instead, which is its own kind of record.',
      'ḪATTI is obsessed with bread and will not tell you how to make any of it. Their texts name well over a hundred kinds and explain almost none. It is cold country, high on the Anatolian plateau, with an archive at Ḫattuša running to tens of thousands of tablets. What marks their cooking out is sweetness against meat, which nobody east of them does: there is a dish that bakes lamb in olive oil and honey together and it is better than it sounds. Good hazelnuts. And chickpeas mashed with cucumber over the top, which I have never met anywhere else.',
      'THE AEGEAN keeps the longest spice list of the five and never once says what it did with any of it. The palace records at Knossos and Pylos are inventories, so you know exactly how much coriander went where and nothing whatever about the dish it went into. Olive oil is the default fat there rather than a luxury, and the sheep cheese is worth crossing water for. Their archives are written in a syllabary that cannot spell a final consonant and does not distinguish l from r, so every Linear B name is a rough sketch of a sound. What you have instead of instructions is the equipment: portable clay grills, with notches cut along the top to seat skewers. Somebody was grilling meat on sticks over charcoal three thousand years ago and the hardware proves it.',
      'CANAAN AND THE COAST is mine, and it left less of a kitchen of its own than any of the others, which is what you would expect of a place that spent its whole time moving everyone else’s food. We are knʿn to ourselves, Kinaḫḫu to a Babylonian clerk, Kinaḫni in the letters to Egypt. Ports, warehouses, other people’s cargo. Olive oil at industrial scale, wine with resin in it, fish, and a drinking society called the marzeaḥ whose paperwork you hold in detail and whose menu you do not have at all.',
      'Set those five side by side and they are not five cuisines. They are one pantry with regional accents. Grain, pulse, allium, oil, sour dairy and bread are the spine everywhere, from Pylos to Nippur. The differences are real and they are seasonings on a shared structure: which fat, which souring agent, whether sweetness is allowed near meat. If you can cook a lentil and barley pot with onions in it, you can cook in any of these five kitchens with a few substitutions.',
      'What is not here matters as much as what is. No tomatoes, no potatoes, no chillies, no maize, no citrus, no sugar, no rice, no chocolate, no coffee. Every one of those arrives later, most of them a great deal later, and most from a continent nobody in this story knows exists. Half of what a modern cook thinks of as Mediterranean cooking is five hundred years old at the outside. The other half is three thousand, and it is the half in the pot.',
    ],
  },
]
