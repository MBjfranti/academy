...
export const fieldReports = [
  {
    ...
    standfirst:
      'Nineteen days on foot from the hills brought me to green country and a walled city. I have spent the week since in the market, working out what the two of them cost.',
    hero: {
      name: 'terqa-arrival',
      ...
      caption: 'The whole argument is visible from up here: everything green lies within a morning’s walk of the water, and nothing at all grows beyond it.',
    },
    figures: [
      {
        ...
        caption: 'I have never been so pleased to see a wall in my life. Read the rest of this knowing it.',
      },
      {
      ...
      {
        name: 'terqa-talk', at: 8, size: 'inset',
        ...
        caption: 'The man with his hands up spent an hour explaining the canal to me. I did not get a word in.',
      },
      {
        ...
        caption: 'No fee, no temple, no tablet — the part of a city that never reaches the records.',
      },
    ],
    pulls: [
      {
    ...
    body: [
      'Nineteen days from the hills, the last four of them across country that has nothing to say for itself: flat, pale, thorn and stone, with the horizon repeating itself in every direction. You know that ground; you have driven across it. Then in the middle of an afternoon I could smell water, and an hour after that the land tipped down into a green line of palms along a river, with a walled city standing on the bank. I sat down and looked at it for a long time before going on.',
      'The pictures people carry of this place are wrong, and mine were too. The green is a ribbon. From that ridge you can see the whole of it — a strip of fields and palms along the water, an hour wide at the most, and then dry ground again for as far as anybody walks. This is not a fertile country with a river running through it but a desert with a seam, and everything that city eats is grown inside a band you could cross on foot before lunch.',
      'The seam does not happen by itself, which took me a while to see properly. In places the river runs above the fields and in places below them, and the water reaches the barley only because somebody cut a channel to bring it there. A channel silts up. Every year it fills with what the river carried into it, and two seasons of neglect will turn the field behind it back into ordinary ground. So the canal is not a thing that was built; it is a thing being built, continuously, by people with baskets, and the bread exists because this year somebody made them do it again.',
      'I came in at dusk behind a line of donkeys, and a man wrote something down about me. It would be easy to be clever about that and it would also be a lie. I have been robbed. I have slept four nights on a mountain listening to every stone that moved. Walking through that gate into a street with people in it, and lying down afterwards without listening for anything, was worth almost any price somebody cared to name. Whatever I say next, that came first.',
      'What I say next is that the man at the gate is not doing a different job from the man who counts barley into the granary, or from the man who sets how many days you owe on the canal this spring. It is one job, and I know that because I did it. Eleven years I spent counting jars into a palace store at Ugarit, and in all that time I thought of myself as a man who was good with jars rather than as part of an apparatus. An apparatus does not announce itself to the people inside it.',
      'So here is the sum, which is not a complaint but arithmetic. Grow more grain than you eat and you have a surplus. A surplus has to go somewhere, so you build a granary. A granary is a target, so you build a wall. Men standing on a wall are not farming, so the granary feeds them. Now you have to know exactly what is in it and who owes what to it, so you need writing, and you need me. Each part follows from the one before it, and nobody sat down and chose any of it.',
      'The market is where you see what all that buys, and I have spent most of a week in it. Grain in open baskets, lentils, chickpeas, dates by the bushel from downriver, sesame oil, wool, salt, onions in ropes, stacked pots, and a long table of split dried fish that is the cheapest protein anybody here carries home. Almost none of it was grown by the person selling it, and that is the achievement — not any single thing on those tables, but that a man with no field and no boat can eat well by standing in a street.',
      'A house in this city burned down about five hundred years before I was born. When you dug it up you found something in a jar that you have been arguing about ever since, because if it is what one of you says it is, then it grew four thousand miles east of here on islands nobody in my world has heard of. I am not going to tell you who is right. I like that the argument exists, because it is a reminder that a market like this one had a back end reaching further than anybody standing in it could have drawn on a map.',
      'Then there is the other cost, the one that has nothing to do with power and does not improve when the king does. Water spread across a field and left to evaporate leaves behind whatever it was carrying, and what it was carrying is salt, a little more of it every year. In time the ground will not take wheat and is fit only for barley, which minds it less. Down south this has been going on for centuries and the bread has gone darker for it; here it is gentler, because the river runs faster and the fields are younger. You argue about how much of the southern story is salt and how much is politics, and you are right to argue, but the direction of it is not in dispute. The canal that makes the city is also, very slowly, unmaking the ground beneath it.',
      'Supper, then. Dried fish off that table, soaked overnight; four onions cooked in sesame oil for a full half hour, which is far longer than seems reasonable and is the whole point, since preserved fish brings salt and no sweetness and the onions have to supply what it lacks; cracked grain stirred through; the fish folded in at the end in large flakes so that it stays in pieces. Sumac over the top, and bread. It cost almost nothing, it is one of the best things I have eaten this year, and every part of it arrived here because the canal runs and the wall stands.',
      'Last night a man told a story in a courtyard, at length, to thirty people sitting on rugs with children asleep against them and food going round. He was very good. Nobody paid him and nobody wrote it down, and it happened at all because a large number of people were safe and fed in one place on the same evening. That is the other thing the wall is for, and your excavations will never find it. I know what it costs. I sat there until it finished.',
    ],
  },
  {
  ...
  },
  {
    ...
    standfirst:
      'We made the crossing. What is on the other side is not a pretty island in the sea — it is a factory, and the cooking has factory manners.',
    hero: {
      name: 'tavern-spread',
      ...
      caption: 'Kuparra’s table, near midnight. She is the one behind it, deciding whether to like me.',
    },
    figures: [
      {
        name: 'tavern-geese', at: 3, size: 'col',
        ...
        caption: 'Third time that evening. She has never once missed and she has never once hit one either, which I now understand is the point.',
      },
      {
        name: 'tavern-pan', at: 5, size: 'inset',
        ...
        caption: 'Flat metal over a live flame. The first cooking surface I have met that gets hotter than the fire seems to warrant.',
      },
      {
        name: 'tavern-herbs', at: 6, size: 'inset',
        ...
        caption: 'She let me cook exactly once, and supervised the whole of it from that position.',
      },
      {
        name: 'tavern-serve', at: 7, size: 'col',
        ...
        caption: 'Fifteen minutes from cold pan to this, which on the rest of this site would not get an onion soft.',
      },
    ],
    pulls: [
      {
        at: 4,
        text: 'Clay gives its heat up slowly, which is why everything else I have cooked this year is a stew. Metal hands it over all at once.',
      },
    ],
    body: [
      'The crossing took a day and a half and I have very little to report about it, which is itself the report. You lose the land behind you in the middle of the morning and you do not get anything in front of you until the following afternoon, and in between there is a great deal of water and nothing whatsoever to look at. Nobody sang. Two of the crew slept the entire way, which I now think was a decision rather than an accident. I ate cold chickpeas on cold bread and thought about how much of what I have been calling seafaring is actually just walking beside a very wet road.',
      'Then Alašiya, and I want to correct something before I go further, because I had it wrong too. You will picture an island: pretty, green, a bay. What is actually here is an industrial site. The smoke is visible from well out at sea, hanging in a line over the low hills inland, and when you land the first thing you meet is not a market but slag — heaps of it, glassy black, cold, sitting where somebody tipped it out of a furnace and never moved it again. This island makes copper for the whole of our world, at a scale that is genuinely difficult to take in, and it looks and smells exactly like what it is.',
      'The tavern is on the harbour and does not appear to close. I got there late enough that the ships were lit and the drinkers were at the stage of the evening where they explain things to you, and the woman running it is called Kuparra, or near enough. I wrote her name down and she read it over my shoulder and laughed at me for a long time, and would not tell me what I had got wrong. Nobody can read the writing on this island — a few hundred inscriptions, no key, no agreement even about what language is underneath — so I am not sure anyone will ever be able to correct me, including her.',
      'She spent the evening throwing rocks at geese.',
      'I should be precise about this, because I have thought about it since. There is a flock that works the harbour, going through the baskets while everyone is busy, and roughly every half hour Kuparra would put down whatever she was holding, walk out into the dark with a stone, and throw it — hard, flat, and with genuinely alarming accuracy — into the middle of them. The geese would go up in a great shrieking mess and settle again forty paces away. She never hit one. I watched carefully and I am confident she has never hit one. When I asked, she said hitting one would mean plucking it, and she was working. Then she went back inside and served four people without breaking stride. I have decided she is simply like this and that the world is better for it.',
      'She grew up two hours inland, beside a smelter, which explains the other thing about her kitchen: she does not cook in clay. She cooks on a flat sheet of metal, set straight over the flame, and on an island that produces copper by the tonne this is not a luxury, it is the cheap option. Everyone here has one. And it changes the cooking completely, in a way I had not appreciated until I stood over it — clay gives its heat up slowly and steadily, which is why every single thing I have cooked this year is a stew, a braise or a long bake. Metal hands it over all at once. You can burn something on purpose in fifteen seconds.',
      'What she does with that is put cheese on it. Firm fresh sheep cheese, sliced thick, dried on a cloth, laid onto a dry screaming-hot pan with no oil at all, and left alone for a minute and a half a side while a dark crust builds on it. Then the oil goes in, then onion rounds, then a great heap of bitter greens turned through the fat until they collapse, and the cheese goes back on top with olives and a hard pour of oil. Bread. That is the whole of it and it takes fifteen minutes, which anywhere else on my travels would not get an onion soft.',
      'It is very good and it is not subtle. Salt, char, bitterness, and a squeak against the teeth. I have eaten a great deal of carefully simmered food this year, and a hot metal surface with four ingredients on it beat most of it, which is not a comfortable finding for a man who has been keeping notes on three-hour braises. Every fried thing you have ever eaten descends from somebody having a piece of hot metal to hand, and on this island that happened early, for reasons that had nothing whatever to do with dinner.',
      'I left the next morning. As we pushed off she was out on the stones again with her arm back, and the geese went up, and she went in.',
    ],
  },
  {
    ...
    standing:
      'The merchant letters you have from us are astonishingly detailed about caravans — the loads, the fodder costs, the tolls, the escorts, the arguments with partners at home, the ones that open by reporting a consignment robbed. Not one of them mentions what anybody ate, because why would it. So this pot is reconstructed from the shipping list rather than from a recipe: it contains only things that demonstrably travelled, cooked the only way one fire and one vessel allow. That is a narrower kind of guess than usual.',
    body: [
  ...
  },
  {
    ...
    body: [
      'Nine days down the Cilician shore and we have not lost sight of land once. I mention it because I know what you picture when somebody says a ship — open water, no horizon, a man staring at the sky and doing something clever with stars. We do almost none of that. We go down the coast the way a cart goes down a road: land on the left hand all day, a beach or a river mouth to put into before dark, and off again at first light. Nine days of it, and I could have walked the whole way along the beach, slowly, and got there.',
      ...
      'What we are carrying is not copper. It is the price of copper, which is a different thing and worth saying out loud, because nobody puts copper on a ship going TO Alašiya — that is where it comes out of the ground. So: jars of oil, bales of cloth, a quantity of tin, and silver by weight in a box the captain sleeps on top of and does not discuss. We are going to buy. The heavy leg is the one home, and on the way back this deck will be carrying ten times the weight it carries now and sitting a great deal lower in the water.',
      'Now the kitchen, which is a clay box. It sits amidships in a bed of sand: fired clay, roughly the size of a large stool, open at the top, a hole in the side to feed it, and a small charcoal fire inside. That is the entire cooking apparatus of a vessel made of wood, linen, rope and pitch — four materials that will between them take a spark and turn nine men into a story other sailors tell. Nobody aboard is relaxed about it. It is lit late, it is watched the whole time, and it goes out before dark.',
      'So the cooking is designed backwards from the box, and the design is severe: one pot, because there is one heat. Nothing needing two temperatures at once. Nothing needing a long boil, because charcoal is cargo too. What Abdi makes — Abdi does the cooking because he is the youngest — is chickpeas, soaked overnight, cooked soft, then oil and onion and cracked coriander in and the whole thing reduced until it is thick rather than wet. Half of it crushed against the side of the pot, half left whole. Then it goes hot onto flatbread spread with cold curd, olives and torn herbs over the top, oil across the lot. You eat it standing. Everyone eats it standing.',
  ...
  },
  {
    ...
    figures: [
      ...
      },
      {
        ...
        caption: 'The baskets are the other half of the household economy, and the half nobody writes about either.',
      },
    ],
    pulls: [
      {
    ...
    body: [
      ...
      'The morning meal is the one that never gets written down anywhere, and it is what most Egyptians were actually eating most of the time.',
  ...
  },
  {
    ...
    body: [
      ...
      'Idaia cooks here. I did not find her in an archive. She is not in one, and neither is anybody else who has ever made a meal in this world. She is a woman of about thirty who feeds crews for a living, holds strong views about other people’s fires, and can gut a bream faster than I can describe it happening. I spent two days in her kitchen and came away with one dish and one idea. The idea is better than the dish, and the dish is very good.',
