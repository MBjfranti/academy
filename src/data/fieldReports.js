...
export const fieldReports = [
  ...
  },
  {
    ...
    body: [
      ...
      'It is very good and it is not subtle. Salt, char, bitterness, and a squeak against the teeth. I have eaten a great deal of carefully simmered food this year and I want to be honest that a hot metal surface and four ingredients beat most of it, which is not a comfortable thing for somebody who has been keeping notes on three-hour braises. Every fried thing you have ever eaten descends from somebody having a piece of hot metal to hand, and on this island that happened early, for reasons that had nothing whatever to do with dinner.',
  ...
  },
  {
    ...
    body: [
      ...
      'The load is copper. Oxhide ingots, the same four-horned slabs I watched come off a ship on the coast a fortnight ago — which is worth saying out loud, because it is easy to talk about a trade route as though it were one thing. It is not. It is a sea leg and then a land leg, with a town in between whose entire purpose is the handover, and the cost structure of the two halves is so different that they may as well be different industries.',
  ...
  },
  {
    ...
    body: [
      'Four days upriver from the Delta and I am standing in the postcard. Mennefer is an old capital and an enormous working town, and behind it on the desert edge are the pyramids, which I should say plainly are not new. They are about twelve hundred years old. The people who built them are as far back from the priests I met this week as those priests are from you. Everyone here treats them the way you treat a mountain — as scenery with a bit of history on it.',
  ...
  },
  {
    ...
    body: [
      ...
      'It is very good, and it is worth being precise about why, because it is not cleverness. It is that hot and cold are touching: the curd slackens where the chickpeas land on it and you get a third texture between the two that neither has alone. That was arrived at by people with no choice about anything else in the meal — and this is the one place I should say plainly that nobody wrote down what a ship’s crew ate. What you have is a hold. One of ours went down off Uluburun and lay on the seabed until you found her — ten tonnes of copper aboard, which tells you she was on the leg we have not done yet — and in among it almonds, pine nuts, figs, olives, grapes, pomegranates, coriander and sumac. That is a shopping list from a working ship. The method is mine.',
  ...
  },
  {
    ...
    body: [
      ...
      'What I want to record is the morning meal, because it is the meal that never gets written down anywhere and it is what most Egyptians were actually eating most of the time.',
  ...
  },
  {
    ...
    body: [
      ...
      'I quoted this at Zuwa. I want to be clear that I knew what I was doing and did it anyway.',
  ...
  },
  {
    ...
    body: [
      ...
      'Here is what I came back with. Kings leave inscriptions. Cooks leave dinner. The inscriptions survive and the dinner does not, which is why every account of this world is full of temples and tribute lists and almost empty of food. That is an accident of what lasts, not a description of what mattered.',
